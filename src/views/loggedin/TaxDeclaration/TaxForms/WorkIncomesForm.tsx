      ...
      {formData?.taxReport?.workIncomes?.workedLastYear === true ? (
        <div className="px-8 py-4 mb-4 bg-gray-100 rounded-lg">
          ...
          <div className="flex items-center gap-2 py-2">
            ...
            <p>J&apos;étais un employé (comprend le travail à la commission)</p>
          </div>
          {formData.taxReport.workIncomes.employed && (
            <>
              ...
              <div className="px-8">
                ...
                <div className="flex items-center gap-2 py-2">
                  <Checkbox
                    {...register('taxReport.workIncomes.outsideCanadaIncome')}
                  />
                  <p>
                ...
                {formData?.taxReport?.workIncomes.jobRelatedExpenses && (
                  <>
                    ...
                    <div className="mx-8">
                      <p>
                        Les dépenses d&apos;emploi peuvent être classées dans
                        une ou plus d&apos;une des catégories suivantes.
                      </p>
                      <p>Cochez toutes les cases qui s&apos;appliquent.</p>
                      <div className="flex items-center gap-2 py-2">
                        <Checkbox
          ...
          <div className="flex items-center gap-2 py-2">
            ...
            />
            <p>
              J&apos;ai reçu des prestations d&apos;assurance-emploi ou de congé
              parental
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 py-2">
            <Checkbox {...register('taxReport.workIncomes.tipsOrCasualWork')} />
            <p>
              J&apos;ai reçu des pourboires ou fait du travail occasionnel et je
              ne recevrai pas de feuillet T4
            </p>
          </div>
        </div>
      ) : (
