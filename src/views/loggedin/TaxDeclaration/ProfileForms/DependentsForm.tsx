          ...
          <>
            ...
            <div id="select" className="w-80 my-4">
              ...
              <Select {...register('dependents.relationship')}>
                ...
                <option value={DependentRelatationShipEnum.NIECE}>Nièce</option>
                ...
                <option value={DependentRelatationShipEnum.UNCLE}>Oncle</option>
                <option value={DependentRelatationShipEnum.AUNT}>Tante</option>
                <option value={DependentRelatationShipEnum.FATHER}>Père</option>
                <option value={DependentRelatationShipEnum.MOTHER}>Mère</option>
                ...
                <option value={DependentRelatationShipEnum.OTHER}>Autre</option>
              </Select>
            </div>
            <div className="my-4">
