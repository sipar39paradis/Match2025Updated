        ...
        <div className='-mx-4 flex flex-wrap items-center'>
          <div className='w-full px-3 lg:w-1/2'>
            <div className='mx-auto mb-12 max-w-[530px] text-center lg:ml-0 lg:mb-0 lg:text-left'>
              <span
                className='wow fadeInUp mb-8 inline-block rounded-full bg-orange-500 bg-opacity-5 py-[10px] px-5 font-heading text-base text-orange-500 dark:bg-white dark:bg-opacity-10 dark:text-white'
                data-wow-delay='.2s'
              >
