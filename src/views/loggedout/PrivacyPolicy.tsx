...
export function PrivacyPolicy() {
  return (
    <div className=" p-16 px-56">
      ...
      <h2>{"Comment nous protégeons vos informations personnelles Nous prenons de nombreuses mesures de sécurité pour protéger vos informations personnelles contre la perte, l'utilisation abusive, l'accès non autorisé, la modification et la divulgation. Voici les mesures de sécurité que nous prenons :"}</h2>
      <h2>Cryptage</h2>
      <p className=" pb-5">
        {
      ...
      <p className=" pb-5">Divulgation à des tiers Nous ne vendons, ne louons ni ne partageons vos informations personnelles avec des tiers à des fins commerciales sans votre consentement explicite. Cependant, nous pouvons divulguer vos informations personnelles à des tiers dans les circonstances suivantes: </p>
      ...
      <p className=" pb-5">Nous pouvons divulguer vos informations personnelles pour protéger nos intérêts légitimes, tels que la protection contre la fraude, la protection de nos droits et ceux de nos utilisateurs, et la protection de notre site web et de nos systèmes informatiques.</p>
      ...
      <p className=" pb-5">{"Vous pouvez demander la suppression de vos informations personnelles en nous contactant à l'adresse email indiquée dans la section \"Nous contacter\"."}</p>

      <p className=" pb-5">Transfert international de vos informations personnelles Nous pouvons transférer vos informations personnelles en dehors de votre pays de résidence pour stocker et traiter ces informations. Nous prenons des mesures pour nous assurer que vos informations personnelles soient protégées en conformité avec les lois applicables sur la protection des données.</p>
      ...
      <p className=" pb-5">{"Nous contacter Si vous avez des questions ou des préoccupations concernant notre politique de confidentialité, veuillez nous contacter à l'adresse suivante : info@impotsmatch.com. Nous ferons de notre mieux pour vous répondre dans les plus brefs délais."}</p>

      <p className=" pb-5">{"Si vous pensez que nous avons traité vos informations personnelles de manière inappropriée, vous pouvez également déposer une plainte auprès de l'autorité de protection des données compétente."}</p>

      <p className=" pb-5">Sécurité de vos informations personnelles Nous prenons la sécurité de vos informations personnelles très au sérieux et nous mettons en œuvre des mesures techniques et organisationnelles pour protéger vos informations contre toute perte, utilisation abusive, accès non autorisé, modification ou divulgation.</p>

      <p className=" pb-5">{"Cependant, aucune méthode de transmission sur Internet ou de stockage électronique n'est complètement sûre. Bien que nous fassions de notre mieux pour protéger vos informations personnelles, nous ne pouvons garantir la sécurité absolue de vos informations transmises sur notre site web ou stockées sur nos systèmes."}</p>

      <p className=" pb-5">En utilisant notre site web, vous reconnaissez que vous comprenez les risques associés à la transmission de vos informations sur Internet et que vous les acceptez.</p>

      <p className=" pb-5">{"En conclusion Nous espérons que cette politique de confidentialité vous aidera à comprendre comment nous utilisons et protégeons vos informations personnelles. Si vous avez des questions, n'hésitez pas à nous contacter."}</p>
    </div>
  );
}
