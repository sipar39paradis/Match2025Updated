            ...
            >
              <div className="relative mb-8 overflow-hidden rounded">
                <img
                  ...
                  className="w-full"
                />
                <div className="duration-300 absolute bottom-6 left-1/2 -translate-x-1/2 translate-y-10 opacity-0 transition group-hover:translate-y-0 group-hover:opacity-100">
