...
const T3_Releve_16 = ['T3_Relevé 16', 'État des revenus de fiducie (répartition et attribution)'];
const T5008_Releve_18 = ['T5008_Relevé 18', 'Opérations sur titres'];
const T5013_Releve_15 = ['T5013_Relevé 15', 'Revenus d\'une société de personnes'];
const T101_Releve_11 = ['T101_Relevé 11', 'Frais d\'exploration et d\'actions accréditives'];
const Releve_7 = ['Relevé 7', 'Placements dans un régime d\'investissement'];
const Releve_10 = ['Relevé 10', 'Crédit d\'impôt relatif à un fonds de travailleurs'];
const Releve_26 = ['Relevé 26', 'Capital régional et coopératif Desjardins'];
const T2022_Releve_8_TL11 = ['T2022_Relevé_8_TL11', 'Frais de scolarité figurant sur un feuillet T2202'];
const T4A_OAS = ['T4A(OAS)', 'Sécurité de la vieillesse'];
const T4A_P_Releve_2 = ['T4A(P)_Relevé 2', 'Prestations du Régime de pensions du Canada ou du Régime de rentes du Québec'];
const T5007_Releve_5 = ['T5007_Relevé 5', 'Prestations d\'assistance sociale ou de la CAT, supplément pour personnes âgées'];
const T4A_Releve_2_Releve_1 = ['T4A_Relevé 2_Relevé 1', 'Pension, retraite, rente et autres revenus'];
const T4RSP_Releve_2 = ['T4RSP_Relevé 2', 'Revenus d\'un régime enregistré d\'épargne-retraite'];
const T4RIF_Releve_2 = ['T4RIF_Relevé 2', 'Fonds enregistré de revenu de retraite'];
const Releve_19 = ['Relevé 19', 'Versements anticipés'];
const RC210 = ['RC210', ''];
const T4_Releve_1 = ['T4_Relevé 1', 'Revenus d\'emploi'];
const T4PS_Releve_25 = ['T4PS_Relevé_25', 'Régime de participation des employés aux bénéfices'];
const T10 = ['T10', 'Facteur d\'équivalence rectifié (FER)'];
const Foreign_income = ['Foreign_income', 'Revenu étranger'];
const Releve_17 = ['Relevé 17', 'Rémunération provenant d\'un emploi à l\'extérieur du Canada'];
const Releve_22 = ['Relevé 22', 'Revenu d\'emploi lié à un régime d\'assurance interentreprises'];
const T4E_Releve_6 = ['T4E_Relevé 6', 'Prestations d\'assurance-emploi'];
const T4A_RCA = ['T4A-RCA', 'Montant reçu pour des régimes d\'accumulation de capital (RAC)']
...
export function mapTitle(title: string): string {
  switch (title) {
    ...
    case T5008_Releve_18[0]:
      return `${T5008_Releve_18[0].replaceAll('_', ' ')}: ${T5008_Releve_18[1]}`;
    case T5013_Releve_15[0]:
      return `${T5013_Releve_15[0].replaceAll('_', ' ')}: ${T5013_Releve_15[1]}`;
    ...
    case T2022_Releve_8_TL11[0]:
      return `${T2022_Releve_8_TL11[0].replaceAll('_', ' ')}: ${T2022_Releve_8_TL11[1]}`;
    case T4A_OAS[0]:
    ...
    case T4A_Releve_2_Releve_1[0]:
      return `${T4A_Releve_2_Releve_1[0].replaceAll('_', ' ')}: ${T4A_Releve_2_Releve_1[1]}`;
